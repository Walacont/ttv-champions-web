...
// Import and re-export utility functions from separate module (for testability)
import {
    isValidTimeFormat,
    isValidDateFormat,
    timeRangesOverlap,
...
// UTILITY FUNCTIONS
// ============================================================================
// Note: Utility functions are now imported from './training-schedule-utils.js'
// and re-exported at the top of this file for backward compatibility.
// This separation allows unit testing without Firebase dependencies.
