...
// Email configuration
const FROM_EMAIL = 'SC Champions <noreply@sc-champions.de>'; // Change after domain verification
const REPLY_TO = 'support@sc-champions.de'; // Your support email
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 20px 0 0 0; color: #1f2937; font-size: 15px;">
                                Sportliche Grüße,<br>
                                <strong>Das SC Champions Team</strong>
                            </p>
                        </td>
                    </tr>
